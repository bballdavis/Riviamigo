...
type CapturedProps = Record<string, unknown> & { points: Array<{ ts: string }>; series: Array<{ values: Array<number | null>; color: string }> };
...
const datasets: ChartDataset[] = [
  ...
  { sourceBindingId: 'second', domain: { kind: 'time', field: 'timestamp', values: ['2026-01-02', '2026-01-03'] }, fields: { timestamp: { kind: 'time', values: ['2026-01-02', '2026-01-03'] }, second_value: { kind: 'number', values: [20, 30] } }, meta: { sourceId: 'metrics.series', sampled: false, partial: false, sourcePointCount: 2 } },
];
...
describe('ChartDefinitionRenderer', () => {
  ...
  it('aligns sources by a sorted domain and forwards the saved display contract', () => {
    ...
    expect(props.points.map((point) => point.ts)).toEqual(['2026-01-01', '2026-01-02', '2026-01-03']);
