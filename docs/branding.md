...
- Timeline interval bars follow the same filled-bar treatment and expose the complete bar as a 44px keyboard/touch hit target. Overlapping intervals are stacked into visual lanes, not summed; hover and focus show the trip route, time, duration, and distance, and Enter/Space activates the trip.
