...
- The test stack is `riviamigo-prod-test`, port `192.168.1.7:8067`, and `/share/Containers/Riviamigo-prod-test/{db,redis,backups,cache,secrets}`.
...
node scripts/dev-harness.mjs \
  ...
  --test-root /share/Containers/Riviamigo-prod-test \
  --env-file /share/Containers/Riviamigo-prod-test/secrets/compose.env \
  --port 8067 \
