...
export const SENSOR_DEFINITIONS: SensorDefinition[] = [
  ...
  { id: 'charging_cycles_summary', title: 'Charging Cycles', dataSource: 'chargingSummary', valuePath: 'charging_cycles', icon: 'lucide:refresh-ccw', chartType: 'none', valueMode: 'latest', valueColor: 'default' },
