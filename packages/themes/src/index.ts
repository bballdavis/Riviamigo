...
const makeTokens = (rad: boolean): Record<SemanticToken, ThemeColorPair> => {
  ...
  const light = rad ? ['#FCFCFA','#FFFFFF','#F8FAF9','rgba(255, 255, 255, 0.88)','rgba(18, 59, 67, 0.42)','#123B43','#355F60','#527278','#A0AEAE','#FFFFFF','rgba(18, 59, 67, 0.10)','rgba(18, 59, 67, 0.18)','rgba(194, 65, 12, 0.34)'] : ['#FAFAF7','#FFFFFF','#F4F4EE','rgba(255, 255, 255, 0.7)','rgba(20, 20, 24, 0.4)','#18181B','#52525B','#71717A','#A1A1A1','#FAFAFA','rgba(20, 20, 24, 0.08)','rgba(20, 20, 24, 0.18)','rgba(253, 131, 4, 0.35)'];
  ...
  const accentLight = rad ? ['#C2410C','#A83B0F','#8E2E0A','rgba(194, 65, 12, 0.14)'] : ['#FD8304','#EA580C','#C2410C','rgba(253, 131, 4, 0.10)'];
  ...
  const chartLight = rad ? ['#F26A2E','#007A4B','#9C5D00','#D02D30','#527278','#F26A2E','#B87900','#007DA3','#007A4B','#7945D8','#D02D30','#007C73','#DE571E','#435BD0'] : ['#C96F08','#047857','#B45309','#DC2626','#71717A','#C96F08','#A16207','#2563EB','#047857','#7C3AED','#DC2626','#047857','#C2410C','#4F46E5'];
  ...
  set(['chart-grid','chart-hover-bg'], rad ? ['rgba(214, 239, 230, 0.09)','rgba(214, 239, 230, 0.035)'] : ['rgba(255, 255, 255, 0.06)','rgba(255, 255, 255, 0.02)'], rad ? ['rgba(18, 59, 67, 0.10)','rgba(18, 59, 67, 0.035)'] : ['rgba(20, 20, 24, 0.08)','rgba(20, 20, 24, 0.03)']);
  set(['charging-active','charging-done','charging-limited','charging-ac','charging-dc','charging-dcfc'], rad ? ['#FFB000','#38E8A5','#FF7054','#36CEFF','#B59AFF','#F077DA'] : ['#FD8304','#10B981','#F87171','#60A5FA','#A78BFA','#C084FC'], rad ? ['#C2410C','#007A4B','#D02D30','#007DA3','#7945D8','#B02A91'] : ['#FD8304','#059669','#EF4444','#3B82F6','#A78BFA','#C084FC']);
  ...
  set(['map-route-0','map-route-1','map-route-2','map-route-3','map-route-4','map-route-5'], rad ? ['#FF7054','#36CEFF','#FFD34E','#B59AFF','#38E8A5','#F077DA'] : ['#60A5FA','#34D399','#A78BFA','#F472B6','#F59E0B','#F87171'], rad ? ['#DE571E','#007DA3','#B87900','#7945D8','#007A4B','#B02A91'] : ['#38BDF8','#34D399','#A78BFA','#F472B6','#F59E0B','#F87171']);
  set(['dm-unknown'], [rad ? '#9CBDB9' : '#7A8B89'], [rad ? '#527278' : '#6B7C7C']);
  set(['glow-sm','glow-md','glow-lg','glow-button'], rad ? ['0 0 20px rgba(255, 176, 0, 0.16)','0 0 40px rgba(255, 176, 0, 0.21)','0 0 60px rgba(255, 176, 0, 0.26)','0 0 20px rgba(255, 176, 0, 0.42)'] : ['0 0 20px rgba(253, 131, 4, 0.15)','0 0 40px rgba(253, 131, 4, 0.20)','0 0 60px rgba(253, 131, 4, 0.25)','0 0 20px rgba(253, 131, 4, 0.40)'], rad ? ['0 0 0 1px rgba(194, 65, 12, 0.12)','0 1px 2px rgba(194, 65, 12, 0.16)','0 2px 8px rgba(194, 65, 12, 0.21)','0 4px 12px rgba(194, 65, 12, 0.28)'] : ['0 0 0 1px rgba(253, 131, 4, 0.10)','0 1px 2px rgba(253, 131, 4, 0.15)','0 2px 8px rgba(253, 131, 4, 0.20)','0 4px 12px rgba(253, 131, 4, 0.25)']);
  set(['shadow-sm','shadow-md','shadow-lg','shadow-xl'], rad ? ['0 1px 2px rgba(0, 0, 0, 0.34)','0 4px 6px rgba(0, 0, 0, 0.34)','0 10px 15px rgba(0, 0, 0, 0.34)','0 20px 25px rgba(0, 0, 0, 0.44)'] : ['0 1px 2px rgba(0, 0, 0, 0.3)','0 4px 6px rgba(0, 0, 0, 0.3)','0 10px 15px rgba(0, 0, 0, 0.3)','0 20px 25px rgba(0, 0, 0, 0.4)'], rad ? ['0 1px 2px rgba(18, 59, 67, 0.07)','0 2px 6px rgba(18, 59, 67, 0.09)','0 8px 20px rgba(18, 59, 67, 0.12)','0 16px 32px rgba(18, 59, 67, 0.14)'] : ['0 1px 2px rgba(20, 20, 24, 0.06)','0 2px 6px rgba(20, 20, 24, 0.08)','0 8px 20px rgba(20, 20, 24, 0.10)','0 16px 32px rgba(20, 20, 24, 0.12)']);
...
const makeTheme = (id: ThemePalette): ThemeDefinition => {
  ...
  const aliases = rad
    ? chart(
      ...
      ['#F26A2E','#007A4B','#9C5D00','#D02D30','#527278','#007A4B','#B87900','#007DA3','#7945D8','#D02D30','#007C73','#435BD0','#697900','#DE571E'],
    )
